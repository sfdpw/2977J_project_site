function qty_table_generator_E_pullboxes(qty_bid_item) {
    ...
    var return_block = 
                 ...
                 '<thead class="qty_thead">\
                    <tr class="qty_tr">\
                        ...
                        <th class="qty_thead" rowspan="2" style="text-align:center; padding:5px">Asset Type</th>\
...

    {
        ...
        for (const pullbox_instance of json_2977J_210_flatwork_points_0["features"])

        {
...

            {
...

                {
                    ...
                    pullbox_instance_extracted_details[0] = (pullbox_instance_properties['INST_ID'].replace(/_/g, "-")).substring(0,13);
