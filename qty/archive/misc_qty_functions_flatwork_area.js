function qty_table_generator_flatwork_area(qty_bid_item) {

    var NN = 0; // bid item index

    while (base_sov[NN]['Bid Item'] != qty_bid_item.replace('R-0','R-')) {
        NN++;
                 ...
                 '<thead class="qty_thead">\
                    <tr class="qty_tr">\
                        <th class="qty_thead" rowspan="2" style="text-align:left;\
                                              padding:5px; width:7%">Instance ID</th>\
                        <th class="qty_thead" rowspan="2" style="text-align:left; padding:5px; width:15%">Location</th>\
                        <th class="qty_thead" rowspan="2" style="text-align:center; padding:5px">QTY ID</th>\
